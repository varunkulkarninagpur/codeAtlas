...
export class ArchitectureExplorerPanel {
  ...
  private static readonly viewType = "codeatlasExplorer";
  ...
  public updateData(graph: ArchitectureGraph, violations: ArchitectureViolation[]): void {
    ...
    const edges: { source: string; target: string; relType: string | undefined }[] = [];
  ...
  private getHtmlForWebview(webview: vscode.Webview): string {
    const scriptUri = webview.asWebviewUri(
      vscode.Uri.file(path.join(this.extensionUri.fsPath, "dist", "explorer", "main.js")),
    );
