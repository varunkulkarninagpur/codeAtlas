export class ComponentTypeResolver {
    constructor() {
        this.SPRING_DATA_REPOSITORIES = new Set([
            "Repository",
            "CrudRepository",
    ...
    resolve(classes) {
        ...
        const isRepositoryCache = new Map();
        const checkIsRepository = (fqn, visited) => {
    ...
    resolveFqName(sourceClass, typeName, allClassList) {
